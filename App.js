                ...
                handler: function() {
                    Ext.create('Rally.ui.dialog.Dialog', {
                        ...
                        items: {
                            ...
                            '<p>The app options will allow you to minimise the number of columns and rows by only showing those with depedencies - giving a more focussed view</p>' +
                           ...
                           ' e.g. filter on Owner, Investment Type, etc. </p><p>You can use the advanced filter to show you items in a particular Program Increment. If there are dependencies from a successor to a Predecessor that was not in the filtered selection, the Sucessors name to the left will blink slowly.</p>' +
